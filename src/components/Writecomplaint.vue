<template>
  <div >
    <div class="title">
      <span><span style="cursor: pointer" @click="goBack">当前位置 : 管理平台 /</span><span class="currentTable"> 我要投诉</span></span>
      <span></span>
    </div>
    <div class="writeCont">
      ...
      <div class="suggest">
        ...
        <span class="usertitle">投诉内容：</span><br>
        <div style="height: 40px"></div>
        ...
        <span><img src="../assets/images/master.png" alt="">
          <span >
            类型 <el-select v-model="type" placeholder="请选择投诉类型"  @change="selectchange">
          <el-option
        ...
        <div ><span class="error errorLeft" v-if="typeEmpty">*请选择投诉类型</span></div>
        ...
        <span>
          <img src="../assets/images/master.png" alt="" style="vertical-align: top;margin-top: 5px">
          <span > 
            ...
            <el-upload
              ...
              <span v-if="btnHidden">
                 <el-button size="small" type="primary" ><img src="../assets/images/files.png" alt="" style="position: relative;top: 3px;">
                  <span>上传附件</span></el-button>
              </span>

        <div slot="tip" class="el-upload__tip" v-if="btnHidden">*单个文件20M以内，最多上传20个</div>
      </el-upload>
          </div>
      </span>
        <div class="comment" >
          <span class="announce subcomment" @click="sub">提交投诉</span><span class="announce subcomment cancel" @click="goback()">取消并返回</span>
        </div>
    </div>
  </div>
</div>
  ...
  export default{
      data(){
        return {
          ...
          editorOption: {
            placeholder: '请输入投诉/建议投诉内容，10000个字符以内',
            modules: {
              toolbar: {
